...
<html lang="en" class="error_page">
    ...
    <title>Error Page - 404</title>
        ...
        <link rel="stylesheet" href="<?php echo config_item('base_url');?>assets/bootstrap/css/bootstrap-responsive.min.css" />
        <!-- main styles -->
        <link rel="stylesheet" href="<?php echo config_item('base_url');?>assets/css/error.css" />
